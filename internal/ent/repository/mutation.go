...
// Mutation represents an operation that mutates the Repository nodes in the graph.
...
// NewMutation creates a new Mutation for the Repository entity.
...
func (m *Mutation) Predicates() []predicate.Repository {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Repository) {
