...
// Mutation represents an operation that mutates the ManifestBlob nodes in the graph.
...
// NewMutation creates a new Mutation for the ManifestBlob entity.
...
func (m *Mutation) Predicates() []predicate.ManifestBlob {
	return m.predicates
}
...
func (m *Mutation) SetManifest(s string) {
	m.manifest = &s
}

// Manifest returns the value of the "manifest" field in the mutation.
func (m *Mutation) Manifest() (r string, exists bool) {
	v := m.manifest
	if v == nil {
		return
	}
...
func (m *Mutation) ResetManifest() {
	m.manifest = nil
}

// SetBlob sets the "blob" field.
func (m *Mutation) SetBlob(s string) {
	m.blob = &s
}

// Blob returns the value of the "blob" field in the mutation.
func (m *Mutation) Blob() (r string, exists bool) {
	v := m.blob
	if v == nil {
		return
	}
...
func (m *Mutation) Where(ps ...predicate.ManifestBlob) {
...
func (m *Mutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ManifestBlob, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Type returns the node type of this mutation (ManifestBlob).
...
func (m *Mutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown ManifestBlob field %s", name)
}
...
func (m *Mutation) AddField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown ManifestBlob numeric field %s", name)
}
...
func (m *Mutation) ClearField(name string) error {
	...
	return fmt.Errorf("unknown ManifestBlob nullable field %s", name)
}
...
func (m *Mutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown ManifestBlob unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *Mutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown ManifestBlob edge %s", name)
}
